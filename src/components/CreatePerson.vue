<template>
  <div class="flex justify-center">
    <form v-on:submit.prevent="createPerson" class="w-1/2 p-6">
      ...
      <div v-if="fullNamePreview" class="mb-4 p-3 bg-blue-50 rounded-md border border-blue-200">
        <label class="mb-1 block text-sm font-medium text-blue-700">Будет сохранено как:</label>
        <div class="text-blue-900 font-medium">{{ fullNamePreview }}</div>
        <small class="text-blue-600">Формат: Фамилия Имя Отчество</small>
      </div>
